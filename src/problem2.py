...
def problem2b(rect, n, delta, win):
    ...
    totalp1 = rect.get_upper_left_corner()
    totalp2 = rect.get_lower_right_corner()

    rect.attach_to(win)

    for _ in range(n):
        rectangle2 = rg.Rectangle(totalp1, totalp2)
        totalp1 = rg.Point(totalp1.x - delta, totalp1.y - delta)
        totalp2 = rg.Point(totalp2.x + delta, totalp2.y + delta)
